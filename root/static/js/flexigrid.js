...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 tname: '', //stratus hack to get tablename
			 dia: '', // hack to advanced search of GRID
			 sala: '', // hack to advanced search of GRID
			 evento: '', // hack to advanced search of GRID
		 	 participante: '', // hack to advanced search of GRID
		...
		var g = {
			...
			populate: function () { //get latest data
				...
				var param = [
					...
					,{ name : 'tname', value : p.tname}
					,{ name : 'dia', value : p.dia}
					,{ name : 'sala', value : p.sala}
					,{ name : 'evento', value : p.evento}
					,{ name : 'participante', value : p.participante}
				];							 
